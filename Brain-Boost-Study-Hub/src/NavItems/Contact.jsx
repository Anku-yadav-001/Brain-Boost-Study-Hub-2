  ...
  const sendEmail = (e) => {
    ...
    <ReactWhatsapp number="+91 7898446814" message="Hello, aman !" style={{background:"black",border:"none"}}  target="_blank">
       ...
       <div className="footer-details">
        ...
        <p style={{marginTop:"5px",fontSize:"15px"}}><b>Disclaimer</b> : This is not an RGPV official site. We do not take any liability for the correctness of material we provide or host. Any messages sent by contact form regarding business or legal inquiry will not be taken seriously.</p>
       </div>
    </div>
    </>
}
